...
#   name        = "/${var.project_name}/${var.environment}/user_pool_client_id"
#   description = "The cognito user pool client id for ${var.project_name} ${var.environment}."
#   type        = "String"
#   value       = each.value.id
#   overwrite   = true
...
#   name        = "/${var.project_name}/${var.environment}/user_pool_client_secret"
#   description = "The cognito user pool client secret for ${var.project_name} ${var.environment}."
#   type        = "SecureString"
