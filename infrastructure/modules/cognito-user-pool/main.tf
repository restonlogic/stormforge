...
#   name        = "/${var.project_name}/${var.environment}/user_pool_id"
#   description = "The cognito user pool id for ${var.project_name} ${var.environment}."
#   type        = "String"
...
#   name        = "/${var.project_name}/${var.environment}/user_pool_endpoint"
#   description = "The cognito user pool endpoint for ${var.project_name} ${var.environment}."
#   type        = "String"
...
#   name        = "/${var.project_name}/${var.environment}/user_pool_arn"
#   description = "The cognito user pool arn for ${var.project_name} ${var.environment}."
#   type        = "String"
