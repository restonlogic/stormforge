locals {
  ...
  amazon_prometheus_ingest_iam_role_arn    = var.enable_amazon_prometheus ? module.irsa_amp_ingest.arn : ""
  amazon_prometheus_ingest_service_account = "${var.project_name}-${var.environment}-amp-ingest"
